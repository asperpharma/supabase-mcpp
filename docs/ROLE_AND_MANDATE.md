...
- **Deployment & Checklist:** For production pushes, cross-verify every step in [APPLY_TO_MAIN_SITE.md](../APPLY_TO_MAIN_SITE.md) and reference [MAIN_PROJECT.md](../MAIN_PROJECT.md) for environment/channel specifics and integrations.
...
1. **Prep for Deployments:** Always check and apply [APPLY_TO_MAIN_SITE.md](../APPLY_TO_MAIN_SITE.md) before a live push.
...
4. **Documentation & Source of Truth:** Keep [MAIN_PROJECT.md](../MAIN_PROJECT.md) and related docs current with any integration or process updates.
