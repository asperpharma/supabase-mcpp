...
If you have a new or updated CSV catalog to push to the store that feeds the main site, see **docs/PLAN_AND_SPEC.md** for full spec (architecture, CSV mapping, idempotency, env, frontend verification).
...
| Plan + CSV sync spec | `docs/PLAN_AND_SPEC.md` |
