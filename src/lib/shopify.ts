...
const SHOPIFY_STOREFRONT_TOKEN = '532a6e7c7d5e9154f2eda3a415b6c961';
...
export async function fetchProducts(first = 24, query?: string, after?: string) {
  const data = await storefrontApiRequest(PRODUCTS_QUERY, { first, query: query || null, after: after || null });
  return {
